...
func TestStatus_IsValid(t *testing.T) {
	tests := []struct {
		...
		{"valid RoundCleared", StatusRoundCleared, true},
		{"valid Selected", StatusSelected, true},
		{"valid Declined", StatusDeclined, true},
...
func TestStatus_UnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{"unmarshal RoundCleared", `"RoundCleared"`, StatusRoundCleared, false, ""},
		{"unmarshal Selected", `"Selected"`, StatusSelected, false, ""},
		{"unmarshal Declined", `"Declined"`, StatusDeclined, false, ""},
